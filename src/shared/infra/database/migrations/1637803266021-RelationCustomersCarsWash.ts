...
export class RelationCustomersCarsWash1637803266021 implements MigrationInterface {
    name = 'RelationCustomersCarsWash1637803266021'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "wash" ("id" character varying NOT NULL, "washType" character varying NOT NULL, "value" integer NOT NULL, "start_wash" TIMESTAMP WITH TIME ZONE, "expected_end_wash" TIMESTAMP NOT NULL, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "customerId" character varying, "carId" character varying, CONSTRAINT "PK_205a12006b234293a56e2c1bffa" PRIMARY KEY ("id"))`);
